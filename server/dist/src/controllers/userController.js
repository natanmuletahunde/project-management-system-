...
const getUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res
            .status(500)
            .json({ message: `Error retrieving users: ${(0, get_error_message_1.getErrorMessage)(error)}` });
    }
});
...
const getUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res
            .status(500)
            .json({ message: `Error retrieving user: ${(0, get_error_message_1.getErrorMessage)(error)}` });
    }
});
