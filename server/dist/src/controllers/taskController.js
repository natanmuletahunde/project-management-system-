...
const getTasks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const pid = projectId && projectId !== "undefined" && projectId !== "null"
        ? Number(projectId)
        : undefined;
    try {
        ...
        res
            .status(500)
            .json({ message: `Error retrieving tasks: ${(0, get_error_message_1.getErrorMessage)(error)}` });
    }
});
...
const updateTaskStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.status(500).json({ message: `Error updating task: ${(0, get_error_message_1.getErrorMessage)(error)}` });
    }
});
...
const getUserTasks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res
            .status(500)
            .json({ message: `Error retrieving user's tasks: ${(0, get_error_message_1.getErrorMessage)(error)}` });
    }
});
